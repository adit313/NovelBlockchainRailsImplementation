...
ActiveRecord::Schema.define(version: 2021_09_14_205338) do
  ...
  create_table "open_blocks", force: :cascade do |t|
    t.string "block_hash"
    t.string "merkle_hash"
    t.string "solution_hash"
    t.string "prev_block_hash"
  ...
  create_table "open_transactions", force: :cascade do |t|
    t.float "amount"
    t.string "destination"
    t.string "transaction_hash"
    t.string "sender"
    ...
    t.integer "nonce"
    t.integer "transaction_index"
    t.bigint "open_block_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["open_block_id"], name: "index_open_transactions_on_open_block_id"
  end

  add_foreign_key "confirmed_transactions", "blocks"
  add_foreign_key "open_transactions", "open_blocks"
end
